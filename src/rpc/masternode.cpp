...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Rubik address\n"
            "  payee          - Print the masternode payout Rubik address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Rubik address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "rubik",               "masternode",             &masternode,             true,  {} },
    { "rubik",               "masternodelist",         &masternodelist,         true,  {} },
    { "rubik",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "rubik",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
