/* src/config/rubik-config.h.  Generated from rubik-config.h.in by configure.  */
/* src/config/rubik-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RUBIK_CONFIG_H

#define RUBIK_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Rubik Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Rubik Core"
...
#define PACKAGE_BUGREPORT "https://github.com/rubikpay/rubik/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rubik Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rubik Core 0.14.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rubikcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://rubik.org/"
