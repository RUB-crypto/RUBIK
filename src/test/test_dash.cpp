...
#define BOOST_TEST_MODULE Rubik Test Suite

#include "test_rubik.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_rubik_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
