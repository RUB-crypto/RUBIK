...
This document provides guidelines for internationalization of the Rubik Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rubik_en.ts` remains unchanged.
