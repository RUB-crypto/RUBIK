...
This mechanism has been integrated into Bitcore-Node-Rubik which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rubikpay/insight-api-rubik#web-socket-api](https://github.com/rubikpay/insight-api-rubik#web-socket-api)
* API: [https://github.com/rubikpay/insight-api-rubik#instantsend-transactions](https://github.com/rubikpay/insight-api-rubik#instantsend-transactions)
