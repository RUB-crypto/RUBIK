# Linearize
Construct a linear, no-fork, best version of the Rubik blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install rubik_hash

https://github.com/rubikpay/rubik_hash
...
JSON-RPC server. Running `rubikd` or `rubik-qt -server` will be sufficient.
...
* `input`: rubikd blocks/ directory containing blkNNNNN.dat
